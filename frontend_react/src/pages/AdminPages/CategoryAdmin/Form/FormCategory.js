...
function FormCategory({ category, handleUpdate, handleInsert }) {
    const [formCategory, setFormCategory] = useState(category ? category : '');
    ...
    const handleSubmitUpdate = () => {
        ...
        if (Object.keys(newErrors).length === 0) {
            handleUpdate(formCategory, mainImage);
        }
    };
    const handleSubmitCreate = () => {
        ...
        setErrors(newErrors);
        if (Object.keys(newErrors).length === 0) {
            handleInsert(formCategory, mainImage);
        }
    };
                        ...
                        <div className="form-group col-md-5">
                            ...
                            <div style={{ maxHeight: '250px', maxWidth: '250px' }}>
                                {mainImage ? (
                                    ...
                                    <img className="w-50 h-50" src={formCategory.image} />
                                )}
                            </div>
                            <input
                                type="file"
